...
export const RecipePage = () => {
  ...
  if (!recipe) return <h1>Recipe not available</h1>
  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <Box
        ...
        src={recipe.url}
      />
      <Typography variant='h5' marginBottom='16px'>{recipe.description}</Typography>
        <Button size='large' component={Link} to={`/recipes/${recipe.id}/edit`}
